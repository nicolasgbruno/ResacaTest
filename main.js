...
fetch("data.json")
    ...
    .then((data) => {
        // Guardo los datosen localStorage para usarlos por fuera del then
    ...
    // Traigo los datos del localStorage para usarlos en las funciones
    bebida = JSON.parse(localStorage.getItem("data"));
